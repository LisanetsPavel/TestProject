...
function Table() {
   EventSupport.call(this);
    ...
    // function Button(name, container) {
    //     // this.button = $('<button/>').text(name).appendTo(container).on('click', trigger('buttonClick'));
    //     return  this.button = $('<button/>').text(name).appendTo(container);
    //
    //
    //
    // }

    // this.Button = function (action, name, className) {
    //     this.name = name;
    //     this.action = action;
